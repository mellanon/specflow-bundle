 ...
 *
 * Generated: 2026-02-04T01:28:25.746Z
 *
...
DROP TABLE IF EXISTS spec_versions;`,
  },
  {
    version: 8,
    name: "approval_gates",
    upSql: `-- Migration 008: approval_gates
...
CREATE INDEX idx_approval_gates_feature ON approval_gates(feature_id);`,
  ...
  },
  {
    ...
    upSql: `-- Migration 009: pipeline_failures
...
CREATE INDEX idx_pipeline_failures_unresolved ON pipeline_failures(resolved_at) WHERE resolved_at IS NULL;`,
  ...
  },
  {
    ...
    upSql: `-- Migration 010: execution_log
...
CREATE INDEX idx_execution_log_feature_phase ON execution_log(feature_id, phase);`,
  ...
  },
  {
    ...
    upSql: `-- Add evolving support columns to features table
...
ALTER TABLE features ADD COLUMN baseline_path TEXT;`,
  ...
  },
  {
    ...
    upSql: `-- Harden sessions and test cases for acceptance testing protocol
...
CREATE INDEX idx_harden_test_cases_session ON harden_test_cases(session_id);`,
  ...
  {
    version: 13,
    name: "drop_stale_harden_tables",
    upSql: `-- Migration 013: Drop stale harden tables
-- The TC-based harden protocol (harden_sessions, harden_test_cases) has been
-- replaced by the template+ingest workflow (acceptance-test.md + results.json).
